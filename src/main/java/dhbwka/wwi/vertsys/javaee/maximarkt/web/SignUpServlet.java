...
public class SignUpServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Eingaben prüfen
        User user = new User(username, password1, vorname, nachname, anschrift, plz, ort, email, tel);
        ...
        // Neuen Benutzer anlegen String username,String password, String vorname, String nachname, String anschrift, String plz, String ort, String email, String tel
        if (errors.isEmpty()) {
            try {
                this.userBean.signup(username, password1, vorname, nachname, anschrift, plz, ort, email, tel);
