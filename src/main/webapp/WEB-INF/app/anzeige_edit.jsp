...
<template:base>
    ...
    <jsp:attribute name="content">
        <c:choose>
            <c:when test="${edit.equals('ansehen')}">
                <h3>Kategorie:</h3>
                <p>${category_name}</p>
                <h3>Anzeigeart:</h3>
                <p>${anzeige_form.values["anzeige_art"][0]}</p>
                <h3>Titel:</h3>
                <p>${anzeige_form.values["anzeige_titel"][0]}</p>
                <h3>Beschreibung:</h3>
                <p>${anzeige_form.values["anzeige_beschreibung"][0]}</p>
                <h3>Preisart:</h3>
                <p>${anzeige_form.values["anzeige_preis_art"][0]}</p>
                <h3>Preis:</h3>
                <p>${anzeige_form.values["anzeige_preis"][0]}</p>
            </c:when>
            <c:otherwise>
